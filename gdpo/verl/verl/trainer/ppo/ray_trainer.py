...
def compute_advantage(
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        correctness_advantage, _ = core_algos.compute_grpo_outcome_advantage(
        ...
        format_advantage, _ = core_algos.compute_grpo_outcome_advantage(
        ...
        advantages = correctness_advantage + format_advantage
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            ...
                            reward_tensor, format_tensor, correctness_tensor, reward_extra_infos_dict = compute_reward(batch, self.reward_fn)
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            reward_tensor, format_tensor, correctness_tensor, reward_extra_infos_dict = ray.get(future_reward)
